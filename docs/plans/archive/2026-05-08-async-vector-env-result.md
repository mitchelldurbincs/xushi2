...
- Added `experiments/configs/phase4_mappo_async_smoke.yaml`, a one-update
...
- `python/.venv/bin/python -m pytest tests/test_vector_env.py tests/test_phase_registry.py::test_phase4_config_can_select_async_vector_backend -q`
  -> 6 passed.
- `python/.venv/bin/python -m train.train --config ../experiments/configs/phase4_mappo_async_smoke.yaml`

...
[`experiments/configs/README.md`](../../experiments/configs/README.md). For the
end-to-end operational checklist, see
[`docs/phase4_clear_runbook.md`](../../docs/phase4_clear_runbook.md).

...
from train.mappo_eval_checkpoint import evaluate_mappo, train_phase4_from_config
...
def __getattr__(name: str):
    deprecated_targets = {
        ...
        "_eval_stats_dict": ("train.mappo_eval_checkpoint", "_eval_stats_dict"),
        "_mappo_matrix_row": ("train.mappo_eval_checkpoint", "_mappo_matrix_row"),
        "_matrix_gate_label": ("train.mappo_eval_checkpoint", "_matrix_gate_label"),
        "_matrix_native_bot_env_fn": ("train.mappo_eval_checkpoint", "_matrix_native_bot_env_fn"),
        "_matrix_retention_summary": ("train.mappo_eval_checkpoint", "_matrix_retention_summary"),
        "_matrix_snapshot_env_fn": ("train.mappo_eval_checkpoint", "_matrix_snapshot_env_fn"),
        "_run_eval_gate": ("train.mappo_eval_checkpoint", "_run_eval_gate"),
        "_run_mappo_matrix_eval": ("train.mappo_eval_checkpoint", "_run_mappo_matrix_eval"),
    }

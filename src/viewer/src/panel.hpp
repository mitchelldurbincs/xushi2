...
struct PanelViewModel {
    // Replay-derived metadata must be owned here because replay/viewer lifetimes
    // can diverge between construction and draw calls.
    ...
    std::string replay_fog_mode;
    std::string replay_layout_hash;
    std::string replay_match_type;
    std::string replay_schedule_summary;
    std::string replay_league_summary;
    std::string replay_snapshot_group;
    std::string replay_snapshot_name;
    std::string replay_loss_mask;
